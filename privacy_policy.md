...
We request the following sensitive permissions solely to provide the App's core functionality:

*   **Usage Access:** Required to track screen time for app limits.
*   **Query All Packages:** Required to let you select apps to block.
*   **System Alert Window (Overlay):** Required to display the "Blocking" screen over prohibited apps.
*   **Notifications:** Required to send you alerts about your timers and limits.

## 3. Data Retention

Since we do not collect your data on our servers, we have no data retention policy for personal information. If you uninstall the App or clear its data, all locally stored information (stats, history, tasks) will be permanently deleted from your device.

## 4. Third-Party Services

The App does not integrate with third-party analytics or advertising networks that track you across other apps or websites.
